...
def args_parser():
    ...
    parser.add_argument('--theta_upload', type=float, default=0.001, help="the fraction of clients: C")
    parser.add_argument('--local_ep', type=int, default=1, help="the number of local epochs: E")
    parser.add_argument('--local_bs', type=int, default=32, help="local batch size: B")
    parser.add_argument('--local_dataset_size', type=int, default=100, help="number of local dataset size")
